        ...
        for action in [
            ...
            if not hitsWall:
                ...
                if nextState == self.corners[3]:
                    corners[3] = True
                cost = 1
                successors.append(((nextState, tuple(corners)), action, cost))
...
def foodHeuristic(state, problem):
    ...
    estimation = len(remainingFood)
    heuristic = (closest + estimation) / 2 
    return heuristic
